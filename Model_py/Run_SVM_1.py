...
#    grid_search = GridSearchCV(rf_model, param_grid=fr_param_grid, cv=custom_cv, return_train_score = True, scoring='roc_auc', n_jobs=1)
    grid_search = GridSearchCV(rf_model, param_grid=fr_param_grid, cv=5, return_train_score = True, scoring='roc_auc', n_jobs=20)
...
outer_path = [serum_path]
#outer_path = [serum_path, baxter_path, zeevi_path]

fname_lists = ['no_psm', '1_psm', '2_psm', '3_psm', '4_psm', '5_psm']
...
result.to_csv(path + 'Thesis/univ_markers_SVM_S.csv')
result2.to_csv(path + 'Thesis/total_markers_SVM_S.csv')

#result.to_csv(path + 'Thesis/univ_markers_RF_SB.csv')
#result2.to_csv(path + 'Thesis/total_markers_RF_SB.csv')

#result.to_csv(path + 'Thesis/univ_markers_RF.csv')
#result2.to_csv(path + 'Thesis/total_markers_RF.csv')
...
#        seed_path = d_path + 'seed' + str(seed_num) + '/'
#        
#        !mkdir $seq_path/RF2 & mv $seq_path/*.sav $seq_path/RF2/

...
hp_path = path + 'Thesis/'
HP = pd.read_csv(hp_path+'Final_univ_markers_SVM.csv', index_col=0)
...
result.to_csv(path + 'Thesis/Final_univ_markers_SVM.csv')

for d_path in outer_path:
    for seed_num in range(0,51):
        seed_path = d_path + 'seed' + str(seed_num) + '/'
        commands = "mkdir " + seed_path + "SVM_univ & mv " + seed_path + "*.sav " + seed_path + "SVM_univ/"
        os.system(commands)
